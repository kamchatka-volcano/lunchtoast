...
struct visitor {
  ...
  explicit visitor(const std::string &name, const std::string &version, const std::string& custom_help)
      : name(name), version(version), custom_help(custom_help){}
